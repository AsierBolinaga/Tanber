...
public class Chat extends CustomActivity
{
	...
	private void sendMessage()
	{
		...
		final Conversation c = new Conversation(s, new Date(),
				TanderFriendsList.user.getUsername());
		...
		po.put("sender", TanderFriendsList.user.getUsername());
	...
	private void loadConversationList()
	{
		...
		if (convList.size() == 0)
		{
			...
			al.add(buddy);
			al.add(TanderFriendsList.user.getUsername());
		...
		else
		{
			...
			q.whereEqualTo("receiver", TanderFriendsList.user.getUsername());
		}
