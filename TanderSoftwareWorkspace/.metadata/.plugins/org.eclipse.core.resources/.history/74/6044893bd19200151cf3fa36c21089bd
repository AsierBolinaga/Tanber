...
import abolinaga.tander.model.Conversation;
...
public class ChatActivity extends CustomActivity
{
	...
	/** The user name of friend. */
	private String strFrined;
	...
	private void sendMessage()
	{
		...
		po.put("sender", OptionsActivity.user.getUsername());
		po.put("receiver", strFrined);
		// po.put("createdAt", "");
		po.put("message", s);
	...
	private void loadConversationList()
	{
		...
		if (convList.size() == 0)
		{
			...
			al.add(strFrined);
			al.add(OptionsActivity.user.getUsername());
		...
		else
		{
			...
			q.whereEqualTo("sender", strFrined);
			q.whereEqualTo("receiver", OptionsActivity.user.getUsername());
		}
